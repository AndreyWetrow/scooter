// Фрилансер по жизни - создание интернет магазина
// плавный показ и сокрытие блоков без использования Jquery
...
searchSelect.addEventListener("click", (e) => {
  if (allowMenu) {
    ...
    _slideToggle(categoriesSearch); // блок который нужно скрыть
  }
});